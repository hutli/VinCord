...
namespace VinCord.Commands
{
   ...
   *  This means that you cannot use 'new VinCordCommands()' to create an instance, but instead you use VinCordCommands.SetupCommands.
   *  Also note that all functions in this class also have to be static.
   */
  internal static class VinCordCommands
  {
    /// <summary>
